...
public class PARegistrationPageClass extends Methods {
    ...
    public PARegistrationPageClass PARegistrationPage (WebDriver driver) {
        this.driver = driver;
        return this;
    }
    ...
    public PARegistrationPageClass checkCheckBoxes(){
    ...
    public PaHvalaPageClass  clickRegistracijaButton(){
